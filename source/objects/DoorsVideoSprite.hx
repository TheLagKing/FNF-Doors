 ...
 * General Usage:
 * ```haxe
 * 	var video = new DoorsVideoSprite(x,y).preload(videoPath, [DoorsVideoSprite.MUTED])
 * 	add(video);
 ...
 * ```
 */
class DoorsVideoSprite extends FlxVideoSprite {
	public static function init() {
		hxvlc.util.Handle.init(['--no-lua']);
	}
	
	public static var _videos:Array<DoorsVideoSprite> = [];
	...
	public function preload(path:Location, ?options:Array<String>):DoorsVideoSprite {
