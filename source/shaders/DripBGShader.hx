...
class DripBGShader extends FlxBasic{
    public var shader(default, null):DripBGShaderGLSL = new DripBGShaderGLSL();
...
class DripBGShaderGLSL extends FlxShader{
    @:glFragmentSource('
        //SHADERTOY PORT FIX
        #pragma header
        ...
        vec3 bgColor = vec3(0.3, 0.1, 0.1);
        vec3 rectColor = vec3(0.6, 0.1, 0.1);
        ...
        //rectangles
        const float total = 30.;//number of rectangles
