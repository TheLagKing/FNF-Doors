...
class GlitchShader extends FlxBasic{
    ...
    public var iMouseX(default, set):Float = 500;
    public var NUM_SAMPLES(default, set):Int = 8;
    public var glitchMultiply(default, set):Float = 0;
    ...
    override public function update(elapsed:Float):Void{
        ...
        iTime += elapsed;
        shader.uTime.value = [iTime];
    }

    public function set_iMouseX(v:Float):Float{
        iMouseX = v;
        shader.iMouseX.value = [v];
        return iMouseX;
    }
    public function set_NUM_SAMPLES(v:Int):Int{
        NUM_SAMPLES = v;
        shader.NUM_SAMPLES.value = [v];
        return NUM_SAMPLES;
    }
    public function set_glitchMultiply(v:Float):Float{
        glitchMultiply = v;
        shader.glitchMultiply.value = [v];
        return glitchMultiply;
    }
}
