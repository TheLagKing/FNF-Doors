...
class Screech extends BaseStage
{
	...
	public static function getPreloadShit():Null<Map<String, Array<String>>> {
		var theMap:Map<String, Array<String>> = [
			"images" => switch(altID){
				case 1: ["screechBG_alt/bg", "screechBG_alt/foreground", 
				"screechBG_alt/shadow"];
				case 2: ["screechBG_alt2/bg"];
				case 3: ["screechBG_alt3/bg", 'screechBG_alt3/front'];
				default: ["screechBG/Screech BG1", "screechBG/Screech Stuff", 
				"screechBG/Screech BG2", "screechBG/Screech BG Shadow"];
			}
		];
	...
	public var dadX:Float;
	public var dadY:Float;
	var floatTime:Float;
	...
	override function create()
	{
		...
		switch(altID){
			case 1: pico = new BGSprite('screechBG/Screech Stuff', 49, 118, 1, 1);
			case 2: pico = new BGSprite('screechBG/Screech Stuff', 49, 118, 1, 1);
			case 3: 
				pico = new BGSprite('screechBG_alt3/outside', -300, -300, 1, 1);
				add(pico);
			default:
				pico = new BGSprite('screechBG/Screech Stuff', 49, 118, 1, 1);
		}

		stageback = switch(altID){
			case 1: new BGSprite('screechBG_alt/bg', 0, 0, 1, 1);
			case 2: new BGSprite('screechBG_alt2/bg', -100, -300, 1, 1);
			case 3: new BGSprite('screechBG_alt3/bg', -300, -300, 1, 1);
			default: new BGSprite('screechBG/Screech BG1', 0, 0, 1, 1);
		}
		add(stageback);

		switch(altID){
			case 1: pico = new BGSprite('screechBG/Screech Stuff', 49, 2118, 1, 1);
			case 2: pico = new BGSprite('screechBG/Screech Stuff', 49, 2118, 1, 1);
			case 3: //none
			default:
				pico = new BGSprite('screechBG/Screech Stuff', 49, 118, 1, 1);
				add(pico);
	...
	{
		door = switch(altID){
			case 1: new BGSprite('screechBG_alt/foreground', 0, 0, 1, 1);
			case 2: new BGSprite('screechBG/Screech BG2', 0, 2000, 1, 1);
			case 3: new BGSprite('screechBG_alt3/front', -300, -300, 1, 1);
			default: new BGSprite('screechBG/Screech BG2', 1379, 0, 1, 1);
		}
		add(door);

		shadow = switch(altID){
			case 1: new BGSprite('screechBG_alt/shadow', 0, 0, 1, 1);
			case 2: new BGSprite('screechBG/Screech BG Shadow', 0, 2000, 1, 1);
			case 3: new BGSprite('screechBG/Screech BG Shadow', 0, 2000, 1, 1);
			default: new BGSprite('screechBG/Screech BG Shadow', 0, 0, 1, 1);
		}
		add(shadow);
		...
		if(altID != 0) {
			...
			boyfriend.color = 0xffacacac;
		} else {
			if(boyfriend.curCharacter != "bf_screech")
				PlayState.instance.triggerEventNote("Change Character", "BF", "bf_screech", 0.0);
		}
	...
	override function update(elapsed:Float){
		...
		bfoffsetX = Std.int(boyfriend.getMidpoint().x - 400);
